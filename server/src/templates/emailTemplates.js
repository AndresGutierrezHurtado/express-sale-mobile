                ...
                <div style="max-width: 600px; margin: 0 auto; padding: 50px 0;">
                    ...
                    <div style="padding: 40px; background-color: white !important; color: #666;">
                        ...
                        ${
                            ...
                            `
                            <p>
                                <a href="${process.env.EXPO_PUBLIC_APP_DOMAIN}/users/${usuario?.usuario_id}" style="display: inline-block; padding: 15px 40px; background-color: #18163a; color: white; text-decoration: none; border-radius: 2px; font-weight: bold;">Ver más información del usuario</a>
                            </p>
                            `
                        }
